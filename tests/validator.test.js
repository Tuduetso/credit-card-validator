...
test('1234567812345670 is valid', () => {
  expect(isAValidCreditCard('21234567812345670')).toBe(false);
});
test('2222405343248877 is valid', () => {
  expect(isAValidCreditCard('2222405343248877')).toBe(false);
});
test('2222990905257051 is valid', () => {
  expect(isAValidCreditCard('2222990905257051')).toBe(false);
});
